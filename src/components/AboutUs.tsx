        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {values.map((value, index) => (
              <motion.div
                key={value.label}
                className="flex flex-col items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 min-w-[120px]"
              ...
              >
                ...
                <span className="font-body text-white font-medium">{value.label}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
